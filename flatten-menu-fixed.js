// Example of flattening nested menu items with parent tracking
const menuItems = [
...
// Method 1: Using a recursive function with parent tracking
...
// Method 2: Using flatMap with recursion (simpler but no parent tracking)
...
// Method 3: Using reduce with recursion (simpler but no parent tracking)
...
// Test all methods
console.log("=== Method 1: Recursive Function (with parent tracking) ===");
...
console.log("\n=== Labels Only (Method 1 with parent tracking) ===");
...
// Show just the labels to see the structure (Method 2 without parent tracking)
console.log("\n=== Labels Only (Method 2 without parent tracking) ===");
flattened2.forEach((item, index) => {
