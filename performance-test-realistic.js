// Performance test for flattening realistic large nested menu items
const menuItems = [
...
console.log("\n" + "=".repeat(60));
const depthMenu20 = createMenuWithDepth(10, 20);
const depthResults20 = performanceTest(
  depthMenu20,
  "Depth Menu (10 items, depth 20)"
);
